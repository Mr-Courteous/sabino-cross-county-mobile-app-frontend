            ...
            >
                ...
                >
                    <View style={styles.header}>
                        ...
                        <Text style={styles.subtitle}>Step 1: Start your student registration</Text>
                    </View>
                    ...
                    <View style={styles.formContainer}>
                        ...
                        <Text style={styles.infoText}>
                            A 6-digit verification code will be sent to your email to confirm your identity.
                        </Text>
                    </View>
                    ...
                    >
                        <Text style={styles.loginLinkText}>
                            Already have an account? <Text style={{ color: '#FACC15', fontWeight: 'bold' }}>Sign In</Text>
                        </Text>
                    </TouchableOpacity>
                </ScrollView>
            </LinearGradient>
