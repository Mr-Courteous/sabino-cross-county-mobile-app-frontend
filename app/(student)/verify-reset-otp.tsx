                    ...
                    >
                        <View style={styles.header}>
                            ...
                            <View style={styles.logoBadge}>
                                <Ionicons name="key" size={24} color="#FACC15" />
                                <Text style={styles.logoText}>IDENTITY RECOVERY</Text>
                            </View>
                        ...
                        <View style={styles.card}>
                            <View style={styles.iconCircle}>
                                <Ionicons name="mail-open" size={40} color="#FACC15" />
                            </View>
                            ...
                            <Text style={styles.otpLabel}>ENTER 6-DIGIT RESET CODE</Text>
                            <CustomInput
                                placeholder="000 000"
                                value={otp}
                                onChangeText={(text) => {
                            ...
                            <View style={styles.timerBox}>
                                ...
                                <Text style={[styles.timerText, timeLeft <= 60 && { color: '#EF4444' }]}>
                                    {timeLeft > 0 ? `CODE EXPIRES IN ${formatTime(timeLeft)}` : 'PROTOCOL EXPIRED'}
                                </Text>
                            </View>

                            <CustomButton
                                title={verifying ? "VERIFYING..." : "CONFIRM RESET CODE"}
                        ...
                        <View style={styles.footer}>
                            <Text style={styles.footerText}>ENCRYPTED RECOVERY PROTOCOL ACTIVE</Text>
                        </View>
                    </ScrollView>
                </LinearGradient>
            </ImageBackground>
